...
const InvoicePdfDocument = ({ invoiceDetails }) => {
  const { company, company_settings, customer, last_bill = [], unique_by_utility = {} } =
    invoiceDetails ?? {};
  let subtotal = null;
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            {["ACCOUNT #", "CUSTOMER NAME", "RATE", "TELEPHONE NUMBER", "SERVICE ADDRESS"].map(
              (header, i) => (
                <View
                  key={i}
                  style={[styles.tableCell, { flex: header === "SERVICE ADDRESS" ? 6 : 1 }]}
                >
      ...
      <View style={styles.table1}>
        ...
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>ACCOUNT NUMBER</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>1146</Text>
        </View>
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>BILLING DATE</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>03/21/2023</Text>
        </View>
        {/* Table Row 2 (Due Date, Amount Due) */}
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>DUE DATE</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>04/21/2023</Text>
        </View>
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>AMOUNT DUE</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>$130.86</Text>
        </View>
        {/* Table Row 3 (Rate Code, Meter #) */}
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>RATE CODE</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>-</Text>
        </View>
        <View style={styles.tableRow1}>
          <Text style={[styles.tableCell1, styles.tableHeader1]}>METER #</Text>
          <Text style={[styles.tableCell1, styles.tableCellRight1]}>-</Text>
        </View>
      </View>
      </Page>
