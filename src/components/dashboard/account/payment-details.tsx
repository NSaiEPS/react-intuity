...
const PaymentForm = () => {
  ...
  const paymentDetails = () => {
    ...
    dispatch(getPaymentDetails(stored?.body?.token, formdata, undefined, setCustomerDetails, setContextLoading));
  };
  React.useEffect(() => {
    paymentDetails();
  }, [stored]);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            >
              ...
              <Typography sx={{ fontSize: 14, color: colors.blue }}>
                Total Payment: ${((Number(watch('amount')) || 0) + (watch('convenienceFee') || 0)).toFixed(2)}
              </Typography>
            </Stack>
          </Box>
          ...
          {isSchedule ? (
            ...
            <Box component={Paper} variant="outlined" sx={{ p: 2, mb: 2 }}>
              ...
              >
                <FormControlLabel value="saved" control={<Radio />} label="Pay with a saved payment method" />
                <FormControlLabel value="no-save" control={<Radio />} label="Pay without saving a payment method" />
              </RadioGroup>
            </Box>
          )}
              ...
              <>
                ...
                >
                  <FormControlLabel
                    ...
                    label={selectedCardDetails?.card_type ?? selectedCardDetails?.account_type}
                  />
                  <Typography
                    sx={{
                  ...
                  <Typography>{selectedCardDetails?.card_number ? 'Card' : 'Bank Account'}</Typography>
                  <Typography>
