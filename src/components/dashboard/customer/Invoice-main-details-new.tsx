    ...
    pl :.5,
         ...
         ml : 2,
          ...
          <Typography sx={{  fontWeight: 600,
                                fontSize: { xs: 18, sm: 20, md: 18 }, pl : 1.2 ,pr :1}}>
            PREVIOUS BALANCE :
          </Typography>
          <Typography sx={{  fontWeight: 600, pr :2,
                                fontSize: { xs: 18, sm: 20, md: 18 },  pl : 1.2 }}>
            ${item?.amount}
          </Typography>
     </Box>
     <Box  sx={{
          ...
          <Typography sx={{ fontWeight: 600,
                                fontSize: { xs: 18, sm: 20, md: 18 }, pr : 2 , pl :1.5}}>
          Total Due :
        </Typography>
        <Typography sx={{ fontWeight: 600,
                                fontSize: { xs: 18, sm: 20, md: 18 } , pr :1.5}}>
      ${last_bill?.[0]?.amount}
        </Typography>
        </Box>
      </Box>
      ...
      <Grid item xs={12} md={6}>
        <Box sx={{ lineHeight: 1.6 }}>
            ...
            <Typography
              component="div"
              sx={{ fontWeight: 600,
                                fontSize: { xs: 18, sm: 20, md: 18 },  ml: .2}}
            >
              {company?.company_name}
