...
import HeaderSectionReact from "../layout/HeaderSectionReact";
    ...
    <Box sx={{ mx: "auto", bgcolor: "#F7F7F7" }}>
      ...
      {Object?.entries(unique_by_utility).map(
        ([key, items]: [string, UtilityItem[]]) => {
          ...
          // Previous balance from extra_params
          ...
          return (
            <Box key={key} sx={{ px: 1.5 }}>
              ...
              {/* ── SERVICE DETAILS CARD ──
                  FIX: was wrapped in <TableRow><TableCell> which constrained width.
                  Now a plain full-width Box so it spans the entire container. ── */}
              <Box
                sx={{
                  width: "100%",
                  p: 1.5,
        ...
        "& td": { py: 1 },
                    ...
                    {/* SUB TOTAL = line items + previous balance */}
                    {/* <TableRow
                      sx={{
                        bgcolor: colors["blue.4"],
                    ...
                    {/* <TableCell
                      ...
                      <TableCell
                        align="right"
                        sx={{ border: 0, pt: 2, fontSize: "16px" }}
                      >
                    ...
                    <TableRow sx={{ bgcolor: "white", "& td": { py: 1 } }}>
                      <TableCell sx={{ border: 0, fontSize: "16px" }}>
                        Tax
                      </TableCell>
                      <TableCell
                        align="right"
      ...
      {/* ── PAYMENT STUB (detach section) ── */}
      <Paper sx={{ py: 3, px: 2, maxWidth: "100%", mx: "auto" }}>

        {/* Dotted tear line — FIX: removed marginTop: 20 that caused extra space above */}
        ...
        >
          ...
          <Grid item>
            <Box sx={{ lineHeight: 1.6 }}>
              ...
              >
                {[company?.city, company?.state_abbrev, company?.zip]
                  .filter(Boolean)
                  .join(", ")}
              </Typography>
            </Box>
