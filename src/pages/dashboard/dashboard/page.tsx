...
const GaugeChart = dynamic(() => import('@/components/dashboard/overview/billing-needle-chart'), { ssr: false });

export const metadata = { title: `Homepage - ${config.site.name}` } satisfies Metadata;
